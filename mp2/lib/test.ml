...
let ss_pair6 sol stu a1 a2 a3 a4 a5 a6 = (fun () -> sol a1 a2 a3 a4 a5 a6), 
									  (fun () -> stu a1 a2 a3 a4 a5 a6)
let ss_pair7 sol stu a1 a2 a3 a4 a5 a6 a7 = (fun () -> sol a1 a2 a3 a4 a5 a6 a7), 
									  (fun () -> stu a1 a2 a3 a4 a5 a6 a7)
